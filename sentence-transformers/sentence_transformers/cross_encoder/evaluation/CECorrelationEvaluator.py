...
class CECorrelationEvaluator:
    ...
    and the gold score.
    """
    def __init__(self, example_pairs: List[InputExample], scores: List[float], name: str='', write_csv: bool = True):
    ...
    def from_input_examples(cls, examples: List[InputExample], **kwargs):
        ...
        return cls(example_pairs, scores, **kwargs)
    ...
    def __call__(self, model, output_path: str = None, epoch: int = -1, steps: int = -1) -> float:
        ...
        pred_scores = model.predict(self.example_pairs, convert_to_numpy=True, show_progress_bar=False)
