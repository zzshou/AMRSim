...
class EmbeddingSimilarityEvaluator(SentenceEvaluator):
    ...
    def __init__(self, sentences1: List[str], sentences2: List[str], scores: List[float], batch_size: int = 16,
                 ...
                 write_csv: bool = True, ref1_graphs_index=None, ref1_graphs_type=None, ref2_graphs_index=None,
                 ref2_graphs_type=None, ref1_pos_ids=None, ref2_pos_ids=None):
        """
    ...
    def from_input_examples(cls, examples: List[InputExample], **kwargs):
        ...
        return cls(sentences1, sentences2, scores, ref1_graphs_index=ref1_graphs_index,
                   ref1_graphs_type=ref1_graphs_type, ref2_graphs_index=ref2_graphs_index,
                   ref2_graphs_type=ref2_graphs_type, ref1_pos_ids=ref1_pos_ids, ref2_pos_ids=ref2_pos_ids, **kwargs)
    ...
    def __call__(self, model, output_path: str = None, epoch: int = -1, steps: int = -1) -> float:
        ...
        import time
        t1 = time.time()
        embeddings1 = model.encode(self.sentences1, graph_index=self.ref1_graphs_index,
                                   graph_type=self.ref1_graphs_type, batch_size=self.batch_size,
                                   show_progress_bar=self.show_progress_bar, convert_to_numpy=True,
                                   pos_ids=self.ref1_pos_ids)
        embeddings2 = model.encode(self.sentences2, graph_index=self.ref2_graphs_index,
                                   graph_type=self.ref2_graphs_type, batch_size=self.batch_size,
                                   show_progress_bar=self.show_progress_bar, convert_to_numpy=True,
